...
var DropSheet = function DropSheet(opts) {
  ...
  function sheetjsw(data, cb, readtype) {
    ...
    for (var i = 0; i < scripts.length; i++) {
      ...
      function removeLastSplit(str, separater) {
          const lastIndex = str.lastIndexOf(separater);
          return 0 > lastIndex ? str : str.substr(0, lastIndex);
      }
      const getWorkerPath = function() {
          return removeLastSplit(location.pathname,'/') + '/js/sheetjsw.js';
      }

      let workerPath = getWorkerPath();
