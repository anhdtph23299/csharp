...
{
    public class CTieuChiDataProvider : CBaseDataProvider, ITieuChiDataProvider
    {
        ...
        public CTieuChiDataProvider(IConfiguration configuration, ISerilogProvider serilogProvider)
        ...
        public CResponseMessage getTieuChi()
        {
            ...
            try
            {
                ...
                #endregion
                cResponse.Data = objSQL.GetDatasetFromSP(SPRoute.sp_TieuChi_FindAll, sp_Params, _m_ConnectionString);
